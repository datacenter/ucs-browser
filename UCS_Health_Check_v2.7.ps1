...
function Generate_Health_Check
{
	...
	$GetUcsData = {
		...
		Get-UcsNetworkElement -Ucs $handle | % {
			...
			$ports_used = (Get-UcsLicense -Ucs $handle -Scope $fi.Id | Select-Object UsedQuant).UsedQuant
			...
			$ports_licensed = (Get-UcsLicense -Ucs $handle -Scope $fi.Id | Select-Object AbsQuant).AbsQuant
		...
		$templates | % {
			...
			$DomainHash.Profiles[$templateId].General.Type = $DomainHash.Profiles[$templateName].Type
